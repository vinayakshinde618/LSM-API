...
module.exports = (sequelize, DataTypes) => {
  class expense_type_masters extends Model {
    /**
  ...
  expense_type_masters.init({
    tenant_id: DataTypes.INTEGER,
    expense_type_name: DataTypes.STRING,
    is_active: DataTypes.BOOLEAN,
    created_by: DataTypes.INTEGER,
    updated_by: DataTypes.INTEGER
  }, {
    sequelize,
    modelName: 'expense_type_masters',
  });
  return expense_type_masters;
};